    <!-- jQuery -->
    <script src="<?php echo base_url('assets');?>/vendors/jquery/dist/jQuery-2.1.4.min.js"></script>
    <script src="<?php echo base_url('assets');?>/vendors/jquery/dist/jQuery.number.min.js"></script>
    <script src="<?php echo base_url('assets');?>/vendors/jqueryvalidate/jquery.validate.js"></script>
    <!-- Datatables --> 
    <!-- Datatables --> 
