...
<table id="records" class="table" cellspacing="0" width="100%">
    ...
    <thead style="background-color:  bisque;">
        ...
        <tr style="background-color:  bisque;">
            ...
            <th rowspan="1" colspan ="8" width="30%">Anggaran</th>

            <th rowspan="1" colspan="8" width="40%">Realisasi</th>

            <th rowspan="2" colspan="2" width="8%">Deviasi</th>

            <th rowspan="3" width="3%">KT</th>
        ...
        <tr class="<?php echo $stat; ?>">
            ...
            <td align='right'> <?php echo number_format($rekap->blj_pegawai)?></td>
            <td align='right'> <?php echo number_format($rekap->blj_barang)?></td>
            <td align='right'> <?php echo number_format($rekap->blj_modal)?></td>
            ...
            <td align='right'> <?php echo number_format($rekap->rl_blj_pegawai)?></td>
            <td align='right'> <?php echo number_format($rekap->rl_blj_barang)?></td>
            <td align='right'> <?php echo number_format($rekap->rl_blj_modal)?></td>
            ...
            <td align='center'><?php echo number_format($komulatif,2);?> </td>
        </tr>
        <?php 
        ...
        <tr style="background-color:  bisque;">
            ...
            <td align='center'><?php echo number_format($tot_komulatif,2);?></td>
