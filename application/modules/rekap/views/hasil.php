...
<table id="records" class="table" cellspacing="0" width="100%">
    ...
    <thead style="background-color:  bisque;">
        ...
        <tr style="background-color:  bisque;">
            ...
            <th rowspan="3" width="15%">Nama SKPD</th>

            <th rowspan="1" colspan ="8" >Anggaran</th>

            <th rowspan="1" colspan="8" >Realisasi</th>

            <th rowspan="2" colspan="2" width="5%">Deviasi</th>

        </tr>
        <tr>
            <th rowspan="1" colspan="2" >BTL</th>

            <th rowspan="1" colspan="3" >BL</th>
        ...
        <tbody>
            <?php 
                ...
                <tr class="program">
                    ...
                    <td align='right'> <?php echo number_format($kegiatan->blj_pegawai); ?></td>
                    <td align='right'> <?php echo number_format($kegiatan->blj_barang); ?></td>
                    <td align='right'> <?php echo number_format($kegiatan->blj_modal); ?></td>
                    ...
                    <td align='right'> <?php echo number_format($kegiatan->rl_blj_pegawai); ?>  </td>
                    <td align='right'> <?php echo number_format($kegiatan->rl_blj_barang); ?>  </td>
                    <td align='right'> <?php echo number_format($kegiatan->rl_blj_modal); ?>  </td>
            ...
            <?php
                if(!empty($kegiatan->subs)) {
                    ...
                    foreach ($kegiatan->subs as $sub)  {
                        ...
                        echo '<td align="right"> ' . number_format($sub->blj_pegawai) . '</td>';
                        echo '<td align="right"> ' . number_format($sub->blj_barang) . '</td>';
                        echo '<td align="right"> ' . number_format($sub->blj_modal) . '</td>';
                        ...
                        echo '<td align="right"> ' . number_format($sub->rl_blj_pegawai) . '</td>';
                        echo '<td align="right"> ' . number_format($sub->rl_blj_barang) . '</td>';
                        echo '<td align="right"> ' . number_format($sub->rl_blj_modal) . '</td>';
            ...
            <td align='right'><?php echo number_format($tot_blj_pegawai);?></td>
            <td align='right'><?php echo number_format($tot_blj_barang);?></td>
            <td align='right'><?php echo number_format($tot_blj_modal);?></td>
            ...
            <td align='right'><?php echo number_format($tot_rl_blj_pegawai);?></td>
            <td align='right'><?php echo number_format($tot_rl_blj_barang);?></td>
            <td align='right'><?php echo number_format($tot_rl_blj_modal);?></td>
