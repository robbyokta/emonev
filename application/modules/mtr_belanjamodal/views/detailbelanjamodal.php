          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12"> 
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Detail Belanja Modal <small></small></h2>
                  ...
                  <div class="x_content">
                    <h2 align="center"><strong>Detail Belanja Modal <br/> <?php echo $data->nama_pengadaan; ?></strong></h2>
                    <br/>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Edit Detail Belanja Modal</h4>
                        </div>
                        <div class="modal-body">
                            <form>
                            <input type="hidden" id="id_bjm" name="id_bjm" value ="<?php echo $data->id_bjm; ?>"  class="form-control col-md-7 col-xs-12">
                            <div class="form-group col-md-8 col-sm-offset-2" >
                              <label class="control-label col-md-4 col-sm-3 col-xs-12"  for="first-name">Jenis Belanja Modal <span class="required"></span>
                              </label>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="javascript:simpantarget()" id="target">
                             ...
                             <input type="hidden" id="id_kegiatan" name="id_kegiatan"   class="form-control col-md-7 col-xs-12" value="<?php echo $data->id_bjm; ?>">
       ...
       <?php $this->load->view('template\datatablescript.php'); ?> 
        ...
        $('input.fisik').number( true, 2 );
          ...
          function simpandetail(){
             $.ajaxSetup({
              ...
              formData = {
                ...
                pelaksana_pekerjaan_awal : $('#pemilihan_penyedia_akhir').val(),
                pelaksana_pekerjaan_akhir : $('#pelaksana_pekerjaan_akhir').val(),
              }
              console.log(formData);
              var tipe = 'POST';
              var dturl = '<?php echo site_url('mtr_belanjamodal/simpandetail');?>';
               $.ajax({
                type: tipe,
                url: dturl ,
                data: formData,
          ...
          function simpantarget(){
           ...
           console.log(formData);
          var tipe = 'POST';
          var dturl = '<?php echo site_url('mtr_belanjamodal/simpantarget');?>';
          $.ajax({
            type: tipe,
            url: dturl ,
            data: formData,
