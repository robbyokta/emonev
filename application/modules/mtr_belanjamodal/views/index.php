              ...
              <div class="col-md-12"> 
                ...
                <?php
                      ...
                      $edit = strtotime($pengguna->edit_blj);
                       if ( $now <= $edit) {
                    ?>
                <button align="right"  class=" col-md-2 col-sm-offset-10 btn btn-primary" onclick="addpengadaan()"> Tambah Belanja Modal</button> 
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Tambah Belanja Modal</h4>
                        </div>
        ...
        <script>
          ...
          var save_method; 
           table = $('#mtr_program').dataTable({
                ...
                "ajax": {
                "url" : '<?php echo site_url('mtr_belanjamodal/data_mtr_belanja_modal');?>',
                "type"  : "POST"
                },
                "columns": [
                        {"data": "skpd", },
                        ...
                        {"data": "anggaran", "render": function ( data, type, row, meta ) {
                          ...
                          {"data": "id_bjm", "render": function ( data, type, row, meta ) {
                             <?php if ( $now <= $edit) { ?>
                              val = '<a class="btn btn-xs btn-primary"  href="<?php echo site_url('mtr_belanjamodal/detailbelanjamodal');?>/'+data+'" type="button">Detail</a><button align="right"  class="btn btn-xs" onclick="<?php echo "edit(";?>'+data+')" >Edit</button>';
                             <?php } else {?>
                              val = '<a class="btn btn-xs btn-primary"  href="<?php echo site_url('mtr_belanjamodal/detailbelanjamodal');?>/'+data+'" type="button">Detail</a>';
                              <?php } ?>
         ...
         function tambah(){
           ...
           stat = $('#tombol').val();
          var tipe = 'POST';
          var dturl = '<?php echo site_url('mtr_belanjamodal/tambahbjm');?>';
          console.log(stat);
          if (stat == 'edit'){
                var tipe = 'POST';
                var dturl = '<?php echo site_url('mtr_belanjamodal/editbjm');?>';
          }
          $.ajax({
            type: tipe,
            url: dturl ,
          ...
          function edit($id){
            ...
            console.log($id);
             ...
             console.log(formData); 
              var tipe = 'POST';
                  var dturl = '<?php echo site_url('mtr_belanjamodal/belanjamodal');?>/'+ $id;
                  $.ajax({
                      type: tipe,
                      url: dturl ,
                      data: formData,
