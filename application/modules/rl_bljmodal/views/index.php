...
<?php $this->load->view('template\header.php'); ?>  
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12"> 
                <div class="x_panel">
                  <table id="rl_bljmodal" class="data" width="100%">
                      <thead>
                        <tr>
       ...
       <?php $this->load->view('template\datatablescript.php'); ?> 
        <script>
          var save_method; 
            table = $('#rl_bljmodal');
            $('#rl_bljmodal').dataTable({
                "processing": true, //Feature control the processing indicator.
                "serverSide": true, //Feature control DataTables' server-side processing mode.
               
                "ajax": {
                "url" : '<?php echo site_url('rl_bljmodal/data_rl_bljmodal');?>',
                "type"  : "POST"
                },
                "columns": [
                        {"data": "kode", },
                        ...
                        {"data": "id_bjm", "render": function ( data, type, row, meta ) {
                          return '<a class="btn btn-xs btn-primary" href="<?php echo site_url('rl_bljmodal/detail');?>/'+data+'" type="button">Detail</a>'
                        } },
                    ],
                 "columnDefs": [
